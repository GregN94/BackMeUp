...
printHelp(){
    printf "${GREEN}BackMeUp${NORMAL} - simple shell script to create and manage your backups.

Script run without any options should create general directory where will be stored all backups, if it doesn't exist.
...
Script can be also run with many options:
  ...
  -t,  -time   or --time,  | -[time in days]  |  Changes \"LiveTime\" of backups.
\n"
